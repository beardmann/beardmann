...
<p align="center">Tech Maverick | Backend Developer | Data Enthusiast | Tech Geek</p>

## ✨ About Me:

- 🛠️ Engineer - **Indus Valley Partners**
- 🚀 Ramping Mono to Micro
- 💡 Proficiency - Python, AWS Lambda, CloudWatch, EventBridge, S3, DynamoDB, SQL, DevOps and much more
- 🌱 Growing myself, one branch at a time
- 🌐 Actively Active on [Instagram](https://instagram.com/) or [LinkedIn](https://linkedin.com/)
...
![GitLab CI](https://img.shields.io/badge/GitLab%20CI-330F63?logo=gitlab)
...
![Windows Terminal](https://img.shields.io/badge/Windows%20Terminal-4D4D4D?logo=windows-terminal)
...
![Tor](https://img.shields.io/badge/Tor-7E4798?logo=tor)

### Designing
![Adobe Premiere Pro](https://img.shields.io/badge/Premiere%20Pro-9999FF?logo=adobepremierepro)
